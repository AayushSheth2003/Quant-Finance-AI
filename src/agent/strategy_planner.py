...
# LangChain dependencies - install with: pip install langchain langchain-google-genai langgraph
...
# Advanced LangChain implementation available when dependencies are installed
